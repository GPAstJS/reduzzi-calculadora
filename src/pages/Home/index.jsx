...
const Home = () => {
    ...
    const onSubmit = (data, openModal) => {
        handleCalculatorData(data, openModal);
    };
                    ...
                    <section className="lg:flex gap-14 sticky">
                        ...
                        <div
                            onClick={handleSubmit((data) => {
                                if (
                                    data.tipoProprietario.value ===
                                    'Pessoa Jurídica'
                                )
                                    return openModal();

                                if (
                                    data.destinacaoObra.value !==
                                    'Casa Unifamiliar'
                                )
                                    return openModal();
                    ...
                    <Controller
                        ...
                        render={({
                            ...
                            <>
                                ...
                                />
                                {getFormErrorMessage(errors, label, required)}
                            </>
                        )}
                    />
                )) ||
